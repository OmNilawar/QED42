...
const CartItem = () => {
  ...
  return (
    <div className="cart mt-24">
      <div className="cart-items-title grid grid-cols-6 gap-4 items-center text-gray-500 text-[max(1vw,12px)]">
        <p>Item</p>
        <p>Title</p>
        <p>Price</p>
        <p>Quantity</p>
      ...
      {products.map((item) => {
        if (cartItems[item.id] > 0) {
          return (
            <div key={item.id} className="cart-item mt-2 text-black">
      ...
      <div className="cart-bottom mt-20 flex flex-col lg:flex-row justify-between gap-[max(12vw,20px)]">
        <div className="cart-total flex flex-col gap-5 flex-1">
          ...
          <button
            ...
            className="mt-6 bg-tomato-500 text-white py-2 rounded-lg w-1/3 hover:bg-tomato-600"
          >
            Proceed to Checkout
          </button>
        </div>
        ...
        <div className="cart-promocode flex-1">
          ...
          <div className="promo-code-details flex justify-between items-center bg-gray-200 rounded-md p-2">
            <input
              ...
              className="bg-transparent border-none pl-2 outline-none"
            />
